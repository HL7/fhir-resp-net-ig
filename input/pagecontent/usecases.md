...
The descriptions for each step in the above diagram where the Data Submitter is hosted at the Data Source Organization include:
* Step 1: The Data Submitter creates a notification (e.g., subscription, CDS Hook, v2 message) in the Data Source’s FHIR Server so that it can be notified when specific events occur in clinical workflows.
...
* Step 5: The Data Submitter submits the created report to the Data Receiver.
...
Implementers may host the Data Submitter in the Data Receiver Organization as illustrated in the diagram below. The steps remain the same.
